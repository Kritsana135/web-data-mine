...
const Frameworks = [
  ...
  },
  {
    key: "Vue.js",
    description:
      "Vue.js มีคุณสมบัติในการช่วยเสริมความสามารถของ HTML block โดยมีความแตกต่างกันในแต่ละ Component อกสารของ Vue.js จะพึ่งพาสถานการณ์เป็นหลักเพื่อให้นักพัฒนาสามารถเรียนรู้ได้ไว สามารถใช้ได้ทั้งแบบ SPA และ Web App ที่มีโครงสร้างซับซ้อน",
    uri: "https://vuejs.org/",
  },
  {
    key: "jQuery",
